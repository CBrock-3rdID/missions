...
// ISIS FACTION 
	if (_faction==5) then {
	_InfPool=	["LOP_ISTS_OPF_Infantry_AR","LOP_ISTS_OPF_Infantry_Rifleman","LOP_ISTS_OPF_Infantry_AT","LOP_ISTS_OPF_Infantry_TL","LOP_ISTS_OPF_Infantry_Rifleman_2","LOP_ISTS_OPF_Infantry_GL","LOP_ISTS_OPF_Infantry_Corpsman","LOP_ISTS_OPF_Infantry_Rifleman_3"];
	_ArmPool=	["LOP_ISTS_OPF_T34","LOP_ISTS_OPF_T55","LOP_ISTS_OPF_BMP2","LOP_ISTS_OPF_BTR60","LOP_ISTS_OPF_M113_W"];
	_MotPool=	["LOP_ISTS_OPF_Landrover","LOP_ISTS_OPF_Landrover_M2","LOP_ISTS_OPF_Offroad_M2"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	[];
...
// TALIBAN FACTION 	
	if (_faction==6) then {
	_InfPool=	["LOP_AM_OPF_Infantry_Engineer","LOP_AM_OPF_Infantry_Corpsman","LOP_AM_OPF_Infantry_GL","LOP_AM_OPF_Infantry_Rifleman_6","LOP_AM_OPF_Infantry_Rifleman","LOP_AM_OPF_Infantry_Rifleman_2","LOP_AM_OPF_Infantry_Rifleman_4","LOP_AM_OPF_Infantry_Rifleman_5","LOP_AM_OPF_Infantry_Rifleman_3","LOP_AM_OPF_Infantry_AT","LOP_AM_OPF_Infantry_Marksman","LOP_AM_OPF_Infantry_AR","LOP_AM_OPF_Infantry_AR_Asst","LOP_AM_OPF_Infantry_SL"];	
	_ArmPool=	["LOP_AM_OPF_BTR60"];
	_MotPool=	["LOP_AM_OPF_BM21","LOP_AM_OPF_Landrover","LOP_AM_OPF_Landrover_M2","LOP_AM_OPF_Landrover_SPG9","LOP_AM_OPF_Nissan_PKM","LOP_AM_OPF_Offroad","LOP_AM_OPF_Offroad_M2","LOP_AM_OPF_Truck","LOP_AM_OPF_UAZ","LOP_AM_OPF_UAZ_AGS","LOP_AM_OPF_UAZ_DshKM","LOP_AM_OPF_UAZ_Open","LOP_AM_OPF_UAZ_SPG"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	[];
	_shipPool=	[];
	_diverPool=	["LOP_AM_OPF_Infantry_Engineer"];
	_crewPool=	["LOP_AM_OPF_Infantry_Engineer","LOP_AM_OPF_Infantry_Corpsman","LOP_AM_OPF_Infantry_GL"];
	_heliCrew=	[];};
...
// ADD CLASSNAMES 	
	...
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	["LOP_AM_OPF_Static_AT4","LOP_AM_OPF_Igla_AA_pod","LOP_AM_OPF_AGS30_TriPod","LOP_AM_OPF_Static_DSHKM","LOP_AM_OPF_Kord","LOP_AM_OPF_Kord_High","LOP_AM_OPF_Static_M2","LOP_AM_OPF_Static_M2_MiniTripod","LOP_AM_OPF_Static_Mk19_TriPod","LOP_AM_OPF_NSV_TriPod","LOP_AM_OPF_Static_SPG9","LOP_AM_OPF_Static_ZU23"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	[];
	_heliCrew=	[];};
