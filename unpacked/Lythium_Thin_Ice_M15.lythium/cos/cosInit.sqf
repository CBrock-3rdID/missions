...
COS_distance=1100;//Set spawn distance
_aerielActivation=false;// Set if flying units can activate civilian Zones

blackListTowns = ["Kunara","Tunkuf","Morut","Zhapir","Mafaraz","Bramar","Ramir","MikisFOB","Puestocrow","Bushlurkercampbase",];// Remove towns from COS

whiteListMkrs=["Marker_Name",];// Add Custom Markers for COS to populate 
...
COScivPool =["LOP_Tak_Civ_Man_06","LOP_Tak_Civ_Man_15","LOP_Tak_Civ_Man_08","LOP_Tak_Civ_Man_Random","LOP_Tak_Civ_Man_10"];	
COSmotPool =["LOP_TAK_Civ_Ural","LOP_TAK_Civ_UAZ","LOP_TAK_Civ_Landrover","LOP_TAK_Civ_UAZ_Open"];
